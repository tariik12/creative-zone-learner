    ...
    fetch(img_hosting_url, {
      ...
      .then((imgResponse) => {
        if (imgResponse.success) {
          ...
          axios.patch(`http://localhost:5000/createCourse/${course._id}`, data).then((res) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6  w-full">
          <div className="flex min-h-full flex-col justify-center px-6  lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              <h2 className="my-10 text-center text-2xl font-bold leading-9 tracking-tight text-orange-900">
                Edit Your Course
              </h2>
            </div>
              ...
              <div className="w-full">
                ...
                <div className="mt-2">
                  ...
                  >
                    ...
                    <option value=" Graphic & Multimedia">
                      {" "}
                      Graphic & Multimedia
                    </option>
