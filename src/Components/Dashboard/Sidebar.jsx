 ...
 useEffect(() => {
    ...
    if (sidebarExpanded) {
      ...
      <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/dashboard/createCourse' || pathname.includes('createCourse')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    {/* <!-- Menu Item Chart --> */}
                    <li>
                    <Link  className={`nav-link flex items-center gap-3 justify-start md:text-xl font-bold uppercase text-white  border-b-0 hover:border-b-4 border-orange-600 ${isRouteActive('/')}`} to='/'> Home</Link> </li>
                    <li>
                    <Link  className={`nav-link flex items-center gap-3 justify-start md:text-xl font-bold uppercase text-white  border-b-0 hover:border-b-4 border-orange-600 ${isRouteActive('/our-courses')}`} to='/our-courses'>Our Courses</Link>
                    </li>
                    <li><Link  className={`nav-link flex items-center gap-3 justify-start md:text-xl font-bold uppercase text-white  border-b-0 hover:border-b-4 border-orange-600 ${isRouteActive('/about-us')}`} to='/about-us'>About US</Link></li>
